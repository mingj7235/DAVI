...
public class CertificatedBoardPreviewOkAction implements Action{
	@Override
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		if (c_dao.certificatedBoardWrite(c_vo)) {
			...
			if(c_dao.certificatedFilesWrite(cf_vo) ) {
				...
				req.setAttribute("cf_vo", cf_vo);
				forward = new ActionForward();
				forward.setRedirect(false);
				forward.setPath("/app/board/certificated_normal_board_preview.jsp");
			}
		}
		return forward;
	}
