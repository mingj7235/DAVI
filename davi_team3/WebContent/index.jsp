						...
						<div class="inner">
							...
							<div class="second_section">
								...
								<section style="padding:9% 0; margin:5% 0;">
									...
									<div style="width:40%;">
										<p style="font-size:1.7rem; color:#7f888f; font-weight:bold; margin-bottom:1%;">일일 영양소 권장 섭취량</p>
										<div id="chart_div3"></div>
										<p style="font-size:1.7rem; color:#7f888f; font-weight:bold; margin-bottom:0;">BMI 지수</p>
										<div id="chart_div2"></div>
										<p style="font-size:1.7rem; color:#7f888f; font-weight:bold; margin-bottom:0; margin-top:3%;">내 몸무게 비교</p>
