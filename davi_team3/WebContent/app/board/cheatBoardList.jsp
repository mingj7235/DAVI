												...
												<c:when test="${FreeBoardList != null and fn:length(FreeBoardList) > 0 }">
													<c:forEach var="freeBoardVO" items="${FreeBoardList}">
														<tr>
															...
															<td id="title"><a href="${pageContext.request.contextPath}/board/freeViewOk.bo?freeNum=${freeBoardVO.getFreeNum()}&page=${nowPage}" class="aboard">${freeBoardVO.getFreeTitle()}</a></td>													
										...
										<div align="center" style="margin-top:4%;">
											...
											<c:choose>
												...
												<fmt:parseNumber var="prevPage" integerOnly="true" value="${divNow*pageSize}" />
													<li><a href="${pageContext.request.contextPath}/board/freeList.bo?page=${prevPage}" class="aboard">Prev</a></li>
												</c:when>
												<c:otherwise>
												...
												<c:forEach var="i" begin="${startPage}" end="${endPage}">
													<c:choose>
														<c:when test="${i eq nowPage}">
															<li><a href="${pageContext.request.contextPath}/board/freeList.bo?page=${i}" 
											...
											<c:choose>
												...
												<fmt:parseNumber var="divPage" integerOnly="true" value="${nowPage/pageSize}" />
												<fmt:parseNumber var="nextPage" integerOnly="true" value="${(divPage + 1) * pageSize + 1}" />
													<li><a href="${pageContext.request.contextPath}/board/freeList.bo?page=${nextPage}" class="aboard">Next</a></li>
												</c:when>
												<c:otherwise>
