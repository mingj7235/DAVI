 			...
 			if(pages != null && pages.length != 0){
 				$.each(pages, function(index, page){	
 	               ...
 	               text += '<div style="display : flex; justify-content: center; height: 30px;"> <div style="width:10%;">' +
 	                     ...
 	                     '<i class="fas fa-ellipsis-h" onclick="#" style="cursor: pointer;"></i></div></div>'
 	               ...
 	               text += '<div style="width: 70%; margin: 3% auto;"><div style="position:relative; width:100%; height: 0; padding-bottom:100%; ">' +
 	                     ...
 	                     '<img id="likeMark" src="${pageContext.request.contextPath}/images/logo_blue_board.png" style="display:none; width:100%; margin-top:10%"></div></div>';
 	               ...
 	               text += '<div style="display : flex; justify-content: flex-start; height: 30px; padding: 5px;"><div>좋아요</div>' +
 	                     '<div class ="icon_color" id="diamond_num" >#</div><div>개</div></div>';
 	               text += '<div style="display : flex; justify-content: flex-start; height: 30px; padding: 5px;">' +
 	                     ...
 	                     '</div></div>';
 	               text += '<div style="display : flex; justify-content: flex-start; height: 30px; padding: 5px;">' +
 	                     '<div style="width: 20%;">댓글쓴이</div><div style="width: 70%;">댓글</div>' +
 	                     '<div id="iconminus" style="width: 10%; text-align: right; margin: 0 5px; cursor: pointer;">' +
 	                     '<i id="" class="far fa-minus-square icon_color" onclick=""></i></div>' +
 	               ...
 	               text += '<div style="display : flex; justify-content: flex-start; height: 30px; padding: 5px;">' +
 	                     ...
 	                     '</div></div><div style="height: 20px; border-top : 1px solid rgba(164, 167, 170, 0.3);)"></div>';	
 				});
 			}
