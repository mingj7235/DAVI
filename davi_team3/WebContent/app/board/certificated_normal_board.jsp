						...
						<div class="certificated_box" style="height: auto; margin-top: 20px; padding-bottom:30px; border-bottom: none;">
							...
							<div id="ajaxFunction">
								...
								<div id = "replyAjaxDiv_${certificatedList[i].getCertificatedNum()}">
				  				...
				  				<%-- 	<div id = "replyContents_${certificatedList[i].getCertificatedNum()}" style="display : flex; justify-content: flex-start; height: 30px; padding: 5px;">
										<div style="width: 20%;">댓글쓴사람 </div>
										<div style="width: 70%;">댓글 내용1 </div>
