		...
		<div class="inner" >
					...
					<div class="info_box" >
						...
						<div class="team">
							...
							<article>
								...
								<p class="makerProfile">
									<strong class="name">김상윤</strong>
									<span class="title">Lorem feugiat adipiscing blandit</span>
								</p>
							</article>
						</div>
				</div>
			...
			<section class="contact" style="border-top:none;">
				...
				<ul class="contact-icons">
					<li class="icon solid fa-home"><a href="#" class="makerInfo">1234 Somewh<br>Nashville, TN 00000</a></li>
					<li class="icon solid fa-phone"><a href="#" class="makerInfo">(800) 555-0000 x12345</a></li>
					<li class="icon solid fa-envelope"><a href="#" class="makerInfo">hello@untitled.tld</a></li>
					<li class="icon brands fa-facebook"><a href="#" class="makerInfo">facebook.com/untitled-tld</a></li>
					<li class="icon brands fa-twitter"><a href="#"class="makerInfo" >twitter.com/untitled-tld</a></li>
				</ul>
			</section>
		</div>
		<div class="copyright">
