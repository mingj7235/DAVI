		...
		<div id="main">
			<div class="inner">
				...
				<div style="display:flex; justify-content:space-between; align-items:center;margin:3% auto; padding:0 10%;">
					...
					<div style="width:40%;">
						<img alt="" src="img/tuna_omelet.jpg" style="max-width:100%; height:auto;">
					</div>
				</div>
				...
				<div style="display:flex; justify-content:space-between; margin:0 auto; padding:0 10%;">
					...
					<div style="width:50%">
						<h3>조리법</h3>
						<ol class="recipe">
							<li> 계란은 참기름, 소금과 함께 미니 다지기에 넣어 알끈 없이 믹싱해주고, 다지기 대신 체에 걸러도 되고 베보자기에 넣고 꾹 짜서 알끈을 제거해도 됩니다.</li>
							<li> 달궈진 팬에 시금치와 참치캔을 넣고 시금치가 숨이 죽을 때까지 볶아줍니다.</li>
							<li> 볶은 참치와 시금치를 접시에 옮겨두고, 키친타월을 이용해 팬을 닦은 뒤 포도씨유를 약간 두르고 중약불에서 달걀물을 부어 70% 정도 익으면 볶아둔 참치와 시금치를 올리고, 치즈도 한 장 올린 뒤 반을 접어 앞뒤로 골고루 익혀줍니다.</li>
							<li> 마지막으로 케첩을 뿌려주면 완성입니다.</li>
						</ol>
					</div>
				</div>
