								...
								<form method="post" action="#">
									...
									<div class="row gtr-uniform" style="text-align:center;">
										<div class="col-12">
											...
											<textarea name="demo-message" id="demo-message" placeholder="내가 되고 싶은 모습" rows="6" style="width:50%; margin:2% auto; height:80px; border:1px solid rgba(0, 59, 251, 0.3); resize: none;" ></textarea>
