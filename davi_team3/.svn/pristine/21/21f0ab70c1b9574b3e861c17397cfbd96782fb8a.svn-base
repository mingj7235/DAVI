...
<html>
	<head>
    	...
    	<link rel="stylesheet" href="${pageContext.request.contextPath}/index_test.css" />
	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner" style="padding:0; margin-left:0; margin-right:0;">
							...
							<!-- Section -->
								<section style="padding:6% 0; background:#f1f3f5;">
								
										 <div style="display:flex; justify-content:center; align-items:center; width:80%; margin:auto; margin-bottom:80px;">
									      	<div class="col-12" style="width:60%; background:#e9ecef;">
									      ...
									      <div style="display:flex; justify-content:center; align-items:center; margin-left:6%; width:80%; margin:auto;">
							...
							<!-- Section -->
							<section>
										<div style="display:flex; justify-content:space-between; align-items:center; margin:3% auto; width:80%;">
