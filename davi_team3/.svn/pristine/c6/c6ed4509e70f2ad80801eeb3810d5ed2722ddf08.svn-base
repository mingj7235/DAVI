									...
									<div class="mainFrame" style="width:50%; margin: 0 auto; font-size: 1em;margin-bottom: 2em;">
										<form method="post" action="#" name="freeBoardViewForm">
											<div class="viewHead" style="margin-bottom: 1em;display: flex;align-items: baseline;">
												...
												<label for="bulletinHead" style="padding-right: 5px;color:#9fa3a6;" >분류:</label>
												<h3 id="bulletinHead" style="margin-right: 15px;">${bf_vo.getFreeHead()}</h3>
											...
											<div class="viewTitle" style="margin-bottom: 1em; width: 80%;">
												...
												<input type="text" id="subjectInput" name="bulletinTitle" placeholder="" value="${bulletinTitle}" style="display: none;">
												
											</div>
											<div>
											
												<!-- 써머노트  폼 불러오기 -->
												<textarea id="summernote" name="bulletinContent" style="box-shadow: inherit; resize: none;" readonly="readonly";>${bf_vo.getFreeContent()}</textarea>
											</div>
											<div class="row" style="margin-top:5px;">
												...
												<span id="list">
													<a href=# style="margin-right: 10px;"><i class="fas fa-clipboard-list"></i></a>
												</span>
												<span id="modify">
													<a href="javascript:enable()" style="margin-right: 10px;"><i class="fas fa-pencil-alt"></i></a>								
												</span>
												<span id="deleteOk">
													<a href="#" style="margin-right: 10px;"><i  class="fas fa-trash-alt"></i></a>													
												</span>
											...
											<article class="replyArti" style="margin-bottom: 10px; ">
												...
												<div class="row" style="margin-top:5px">
													...
													<div class="col-2" style="margin:auto 0;padding-left: 10%;">
														<c:if test="${true}">
															<a href="javascript:replyOk(${bulletinNum}, ${replyLevel})"><i class="fas fa-edit"></i></a>
														</c:if>											
													</div>											
												</div>										
											</article>
													...
													<article id="replyAnswer${replyNumber}" class="replyArti" style="display: none;">
														...
														<div class="row" style="margin-top:5px">
															...
															<div class="col-2" style="padding-left: 10%;">
																<c:if test="${true}">
																	<a href="javascript:replyOk(${bulletinNum}, ${replyNumber}, ${replyLevel})"><i class="fas fa-edit"></i></a>
																</c:if>											
															</div>											
														</div>										
													</article>
