							...
							<!-- Content -->
								<section style="padding-top:3%;">
										...
										<div style="text-align: center;">
											...
											<div>
												<button type="button" id = "alert" class="button payListBtn" style="width:30%; margin:1% auto; font-size: 1em;" onclick ="payListCheck()">결제 내역 조회</button>
								...
								<c:if test="${listCheck == 'fail'}">
									<section class="modal modal-section type-alert">
							            <div class="enroll_box">
							                <p class="menu_msg"></p>
							            </div>
							            <div class="enroll_btn">
							                <button class="btn davicolor_btn modal_close">확인</button>
							            </div>
	      							 </section>			
								</c:if>
							<div>
